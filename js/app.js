...
class CarritoController{
    ...
    Añadir(Producto){
        ...
        let arryEnFormatoJSON = JSON.stringify(this.listaCarrito)
        localStorage.setItem("listaCarrito",arryEnFormatoJSON)
    }
                    ...
                    <div class="row g-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class= "eliminar-producto">
                                <button id="eliminar${Producto.id}"> <i class="fa-solid fa-trash"></i> </button>
                            </div>
                        </div>
                        </div>
                    </div>
